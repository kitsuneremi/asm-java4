	...
	<form method="post">
		<div style="display: flex">
			...
			<div style="display: block;">
				...
				<div>
					<input type="radio" name="status" value="1" id="inactive" />
					<label for="inactive">inactive</label> <input type="radio"
						name="status" value="0" id="active" checked="${active}"/> <label for="active">active</label>
				</div>
			</div>
		</div>
		<div>
			<label for="des">des</label> <input type="text" name="des" id="des" value="${des}"/>
		</div>
		<div>
